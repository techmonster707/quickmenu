		...
		<div class="card-body">
			...
			<div class="row">
				<div class="form-group col-md-6">
					<input type="text" name="username" class="form-control" placeholder="Codecanyon Account Name " required readonly>
				</div>
				<div class="form-group col-md-6">
					<input type="email" name="account_email" class="form-control" placeholder="Codecanyon Account Email " required readonly>
				</div>
			</div>
		</div>
                ...
                if(json['st']==0){
                   ...
                   $btn.btn('reset');
                    ...
                    if(json.buyer){
                        ...
                        $('[name="account_email"]').val(json.account_email);
